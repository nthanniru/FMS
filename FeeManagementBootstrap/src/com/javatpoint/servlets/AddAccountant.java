...
import com.javatpoint.dao.DB.AccountantDao;
...
public class AddAccountant extends HttpServlet {
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int seq_no = AccountantDao.seq_no();
		AccountantBean bean=new AccountantBean(seq_no,name, email, password, address, contact);
